...
import BisinessDetailsScreen from "../Screens/BusinessDetailsScreen/BisinessDetailsScreen";
...
export default function HomeNavigation() {
  return (
    <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name='business-detail' component={BisinessDetailsScreen}/>
    </Stack.Navigator>
  )
}